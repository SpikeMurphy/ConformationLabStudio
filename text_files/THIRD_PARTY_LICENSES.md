...
- [JAX – Apache License 2.0](https://github.com/jax-ml/jax/blob/main/LICENSE)
- [MMseqs2 – MIT License (via ColabFold)](https://github.com/soedinglab/MMseqs2/blob/master/LICENSE.md)
...
- [Conda / Conda-Pack – BSD License](https://github.com/conda/conda-pack/blob/main/LICENSE.txt)
- PyInstaller – [GPL 2.0 License, with an exception](https://pyinstaller.org/en/stable/license.html)

Full license texts for AlphaFold2 and ColabFold are included separately.
