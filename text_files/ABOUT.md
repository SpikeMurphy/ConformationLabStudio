...
and to make protein structure prediction a bit more accessible for young scientists who may face financial or technical barriers.
Through building it, I’ve gained hands-on experience with subprocesses, file handling, and user interface design and I’m continuing to improve it step by step.
This project reflects my curiosity, learning process, and appreciation for open-source software and the scientific community.

This project will be submitted to **Harvard University's CS50 Python: Introduction to Programming with Python**.
