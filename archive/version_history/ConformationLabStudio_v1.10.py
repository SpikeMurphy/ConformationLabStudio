...
def run_button_command():
    ...
    status_label.config(text="Starting prediction...")
            ...
            for line in process.stdout:
                if line.strip():
                    ...
                    if "setting max_seq" in low:
                        status_label.config(text="Running Multiple Sequence Alignment...")
                    elif "model_1" in low:
                        status_label.config(text="Predicting with Model 1...")
                    elif "model_2" in low:
                        status_label.config(text="Predicting with Model 2...")
                    elif "model_3" in low:
                        status_label.config(text="Predicting with Model 3...")
                    elif "model_4" in low:
                        status_label.config(text="Predicting with Model 4...")
                    elif "model_5" in low:
                        status_label.config(text="Predicting with Model 5...")
                    elif "relax" in low:
                        status_label.config(text="Relaxation step...")
...
'''
python '/Users/spikemurphymuller/Library/Mobile Documents/com~apple~CloudDocs/Spike/University/University of Hamburg/Medizinstudium/AG Prof. Dr. M. Jücker/Project_4_ConformationLab/Application Generation/Current version/ConformationLabStudio_v1.10.py'
'''