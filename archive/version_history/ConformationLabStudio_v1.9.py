...
# Parameters ==================================================
## Path selection
path_frame = LabelFrame(scrollable_frame, text="Path", padx=10, pady=10)
...
input_entry = Entry(path_frame, textvariable=inputpath_selected, bg="#2b2b2b")
...
output_entry = Entry(path_frame, textvariable = outputpath_selected, bg="#2b2b2b")
...
## assembly type
assembly_frame = LabelFrame(scrollable_frame, text="Path and Assembly", padx=10, pady=10)
...
assembly_type_label = Label(assembly_frame, padx=10, text = "Assamble Type:")
...
## Seeds
seeds_frame = LabelFrame(scrollable_frame, text="Seeds", padx=10, pady=10)
...
num_seeds_entry = Entry(seeds_frame, bg="#2b2b2b", validate="key", validatecommand=vcmd_numbers)
...
### --random-seed
random_seeds_label = Label(seeds_frame, padx=10, text="Randome Seeds:")
random_seeds_label.grid(row=1, column=0, sticky="w")
random_seeds_entry = Entry(seeds_frame, bg="#2b2b2b", validate="key", validatecommand=vcmd_numbers)
...
## Modle
model_frame = LabelFrame(scrollable_frame, text="Model", padx=10, pady=10)
...
model_type_var = StringVar(value = "alphafold2_ptm")
...
## Recycles
recycles_frame = LabelFrame(scrollable_frame, text="Recycles", padx=10, pady=10)
...
num_recycle_entry = Entry(recycles_frame,  bg="#2b2b2b", validate="key", validatecommand=vcmd_numbers)
...
recycle_early_stop_tolerance_entry = Entry(recycles_frame,  bg="#2b2b2b", validate="key", validatecommand=vcmd_numbers_or_auto)
...
msa_frame = LabelFrame(scrollable_frame, text="Multi Sequence Alignments", padx=10, pady=10)
...
max_msa_entry1 = Entry(max_msa_frame, bg="#2b2b2b", validate="key", validatecommand=vcmd_numbers)
...
max_msa_entry2 = Entry(max_msa_frame, bg="#2b2b2b", validate="key", validatecommand=vcmd_numbers)
...
msa_mode_var = StringVar(value = "mmseqs2_uniref")
...
## Ranking
ranking_frame = LabelFrame(scrollable_frame, text="Ranking", padx=10, pady=10)
...
## Templates
templates_frame = LabelFrame(scrollable_frame, text="Templates", padx=10, pady=10)
...
templates_var = StringVar(value = "No")
...
## Amber Relaxation
relaxation_frame = LabelFrame(scrollable_frame, text="Relaxation", padx=10, pady=10)
...
num_relax_entry = Entry(relaxation_frame,  bg="#2b2b2b", validate="key", validatecommand=vcmd_numbers)
...
toggle_num_relax()
## Output
output_frame = LabelFrame(scrollable_frame, text="Output", padx=10, pady=10)
...
def clear_button_command():
    ...
    #
    model_type_var.set("alphafold2_ptm")
    #
    #
    ...
    msa_mode_var.set("mmseqs2_uniref")
    pair_mode_var.set("unpaired_paired")
    #
    rank_var.set("plddt")
    templates_var.set("No")
    #
...
cancel_button.grid(row=11, column=1, padx=5, pady=10)
process = None
...
loading_label.grid(row=13, column=0, pady=5)
...
'''
python "/Users/spikemurphymuller/ConformationLabGeneration/ConformationLabStudio_v1.8.py"
'''

'''
python '/Users/spikemurphymuller/Library/Mobile Documents/com~apple~CloudDocs/Spike/University/University of Hamburg/Medizinstudium/AG Prof. Dr. M. Jücker/Project_4_ConformationLab/Application Generation/Current version/ConformationLabStudio_v1.9.py'
'''